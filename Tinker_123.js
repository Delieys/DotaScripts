...
/***/ (function(module, exports) {
	...
	(function (Tinker_Spammer) {
		...
		let menu_ComboRocket = Menu.AddKeyBind(path, 'Key', Enum.ButtonCode.KEY_NONE)
			...
			if (gameStarted && enableMenu) {
				if (Engine.OnceAt(0.2)) {
					...
					if (menu_ComboKey.IsKeyDown() || menu_CreepKey.IsKeyDown()) {
						...
						if ((menu_ComboKey.IsKeyDown() || (menu_CreepKey.IsKeyDown() && rocketFarm) || menu_ComboRocket.IsKeyDown())) {
